function love.load()
    ...
    audio.shutter1= love.audio.newSource('wares/95120__robinhood76__01673-robotics-move1.wav','static')
    audio.shutter1:setVolume(0.7)
    audio.shutter2= love.audio.newSource('wares/95120__robinhood76__01673-robotics-move2.wav','static')
    audio.shutter2:setVolume(0.7)
    audio.shutterlong= love.audio.newSource('wares/95120__robinhood76__01673-robotics-move3.wav','static')
    audio.shutterlong:setVolume(0.7)
